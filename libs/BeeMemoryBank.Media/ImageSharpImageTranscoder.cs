...
/// <summary>
/// ImageSharp-backed <see cref="IImageTranscoder"/>. The single source of truth for the
/// transcoding constants (max dimension + JPEG quality ladder), so that
/// <see cref="BeeMemoryBank.Core.Services.MediaService"/> never references SixLabors directly.
/// </summary>
