...
/// <summary>
/// ImageSharp-backed <see cref="IImageTranscoder"/>. Carries the constants that previously lived
/// in <c>MediaService</c> (max dimension + JPEG quality ladder) so the transcoder is the single
/// source of truth for those values now that Core no longer references SixLabors.
/// </summary>
