...
public class Media
{
    ...
    // Owner key of whoever uploaded a row that isn't linked to an article yet (see
    // ArticleService.LinkAttachmentsAsync). Node-local, never synced; null once irrelevant.
