    ...
    public async Task<MigrationResult> RunAsync()
    {
        ...
        // Initialize node if needed
        {
            ...
            if (existing == null)
            {
                ...
                // Migrator: reuse node name as admin username (admin can rename via Profile later).
                await initService.InitializeAsync(_opts.NodeName, _opts.NodeName, _opts.Password);
